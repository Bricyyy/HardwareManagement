 ...
 * @author Cabuyao Col
 */
public class resetMethods extends javax.swing.JFrame {

    /**
     * Creates new form resetMethods
     */
    public resetMethods() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Select a method to reset your Password");

        phone.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N
        phone.setForeground(new java.awt.Color(3, 127, 54));
        ...
        email.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N
        email.setForeground(new java.awt.Color(3, 127, 54));
    ...
    private void phoneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_phoneMouseClicked
        forgotPassPhone f = new forgotPassPhone();
        f.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_phoneMouseClicked

    private void emailMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_emailMouseClicked
        forgotPassEmail f = new forgotPassEmail();
        f.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resetMethods.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resetMethods().setVisible(true);
            }
        });
    }
